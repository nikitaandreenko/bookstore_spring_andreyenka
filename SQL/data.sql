...
VALUES ((SELECT id FROM users WHERE email = 'n.sw@gmail.com'), 0.0,(SELECT id FROM statuses WHERE name = 'PENDING')),
       ((SELECT id FROM users WHERE email = 'n.mcl@gmail.com'), 0.0,(SELECT id FROM statuses WHERE name = 'PENDING')),
       ((SELECT id FROM users WHERE email = 's.gr_4@mail.com'), 0.0,(SELECT id FROM statuses WHERE name = 'PENDING')),
       ((SELECT id FROM users WHERE email = 'WR.10@gmail.com'), 0.0,(SELECT id FROM statuses WHERE name = 'CONFIRMED')),
       ((SELECT id FROM users WHERE email = 'm.rmc@gmail.com'), 0.0,(SELECT id FROM statuses WHERE name = 'CONFIRMED')),
       ((SELECT id FROM users WHERE email = 'samanta_rob123@gmail.com'), 0.0,(SELECT id FROM statuses WHERE name = 'PENDING')),
       ((SELECT id FROM users WHERE email = 'selena_love_sing@gmail.com'), 0.0,(SELECT id FROM statuses WHERE name = 'CONFIRMED')),
       ((SELECT id FROM users WHERE email = 'ral.12387@mail.com'), 0.0,(SELECT id FROM statuses WHERE name = 'PENDING')),
       ((SELECT id FROM users WHERE email = 'br_spacey.com'), 0.0,(SELECT id FROM statuses WHERE name = 'PENDING')),
       ((SELECT id FROM users WHERE email = 'helena.ras456@gmail.com'), 0.0,(SELECT id FROM statuses WHERE name = 'PENDING')),
       ((SELECT id FROM users WHERE email = 'mik.walent@mail.com'), 0.0,(SELECT id FROM statuses WHERE name = 'PENDING')),
       ((SELECT id FROM users WHERE email = 'locat.ital12@gmail.com'), 0.0,(SELECT id FROM statuses WHERE name = 'PENDING')),
       ((SELECT id FROM users WHERE email = 'pet.jeck1987@gmail.com'), 0.0,(SELECT id FROM statuses WHERE name = 'PENDING')),
       ((SELECT id FROM users WHERE email = 'swans.mol1999@gmail.com'), 0.0,(SELECT id FROM statuses WHERE name = 'PENDING')),
       ((SELECT id FROM users WHERE email = 'jeferson19991999@gmail.com'), 0.0,(SELECT id FROM statuses WHERE name = 'PENDING')),
       ((SELECT id FROM users WHERE email = 'par.jim_1998@mail.com'), 0.0,(SELECT id FROM statuses WHERE name = 'PENDING')),
       ((SELECT id FROM users WHERE email = 'sam.petry15678@gmail.com'), 0.0,(SELECT id FROM statuses WHERE name = 'CONFIRMED')),
