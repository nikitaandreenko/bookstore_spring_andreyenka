...
<form class="form" align=center action="/users/update/${user.id}" method="post">
    ...
    <br><br>
    <label>Password: <input type="text" placeholder="password" name="password" value="${user.password}"/></label>
    <br><br>
    <label>Role: <select placeholder="role"name="role" value="${user.role}">
        <option>USER</option>
